Imports cCommon
Partial Class ForecastingUpdates
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack Then
            If lstOpportunities.SelectedValue = "-1" Or String.IsNullOrEmpty(lstOpportunities.SelectedValue) Then
    ...
    Protected Sub grdAssignments_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles grdAssignments.RowUpdating
        ...
        Dim PersonID As String = CType(selectedRow.FindControl("lblPersonID"), Label).Text
        ...
        ODS_Assignments.UpdateParameters.Add("FK_OpportunityID", TypeCode.Double, lstOpportunities.SelectedValue)
