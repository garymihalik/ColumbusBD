<%@ Page Language="VB" AutoEventWireup="true" CodeFile="BenchReport.aspx.vb" Inherits="BenchReport" %>
           ...
           <asp:UpdatePanel runat="server" ID="pnlBenchReport" ChildrenAsTriggers="true">
                <ContentTemplate>
                   ...
                   SaveButtonID="btnSaveBulkEdit"
                    ...
                    Width="80%" Visible="True" EmptyDataText="No Resources Matching Criteria Found" AllowSorting="true" >
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                        ...
                                        <td colspan="100%">
                                            <div id="div<%# Eval("PK_PersonID") %>" style="display:none;position:relative;left:15px;OVERFLOW: auto;WIDTH:97%" >
                                                <asp:GridView ID="GridView2" AllowPaging="false" AllowSorting="false" BackColor="White" Width="100%" Font-Size="X-Small"
                                                    AutoGenerateColumns="false" Font-Names="Verdana" runat="server" ShowFooter="False" OnRowdataBOund="GridView2_RowDataBound" EmptyDataText="Not currently assigned or allocated">
                                                    <Columns>
                                                        <asp:BoundField DataField="PK_PersonID" HeaderText="Person ID" Visible="false" SortExpression="PK_PersonID"/>
                                                        <asp:BoundField DataField="Client" HeaderText="Client" Visible="true" SortExpression="Client" ItemStyle-Width="33%"/>
