<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Pipeline2XML.aspx.vb" Inherits="DatagridDefault" EnableEventValidation="false" %>
...
<head runat="server">
    <title>Export Pipeline to XML</title>
</head>
<body>
        ...
        <div id="content" >
            <asp:UpdatePanel ID="pnlUpdate" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlUpdate2" runat="server" />
                    ...
                    <asp:Button runat="server" ID="btnXML" Text="Export XML" />
