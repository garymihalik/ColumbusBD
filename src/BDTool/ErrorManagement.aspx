<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ErrorManagement.aspx.vb" Inherits="ErrorManagement" EnableEventValidation="false"%>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="header" >
            ...
            <asp:Image ID="imgLogo" runat="server" skinid="mainlogo" ImageUrl="~/commonimages/logo.gif" />Error Management<br />
        </div>
        <div id="leftcol" >
            <uc3:Navigation ID="Navigation1" runat="server" Location="ErrorList"/>
        </div>
        <div id="content1" >
            <asp:ObjectDataSource ID="ODS_ErrorList" runat="server" TypeName="cErrorManagement" SelectMethod="GetListOfErrors" >
                <SelectParameters>
            ...
            <asp:GridView runat="server" id="grdErrorList" AutoGenerateColumns="false" EmptyDataText="No Records Found"
                ...
                DataKeyNames="ID" EnableViewState="True" SelectedRowStyle-CssClass="selectedrow">
                ...
                <Columns>
                    <asp:BoundField DataField="ID" SortExpression="Error ID" Visible="True" HtmlEncode="false"/>
                    <asp:BoundField DataField="ModuleArea" HeaderText="Module Area" SortExpression="ModuleArea" HtmlEncode="false"/>
                    <asp:BoundField DataField="ErrorText" HeaderText="Error Description" SortExpression="ErrorText" HtmlEncode="false"/>
                    <asp:BoundField DataField="ErrorDateTime" HeaderText="Created On" SortExpression="ErrorDateTime" DataFormatString="{0:g}" HtmlEncode="false" />
                </Columns>
            </asp:GridView>
        </div>
        <div id="footer">
