...
Partial Class DatagridDefault
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            Response.Redirect("login.aspx")
        End If
        Dim btnTest As New KrishLabs.Web.Controls.ExportToExcel
        With btnTest
            .ApplyStyleInExcel = "True"
            .Charset = "utf-8"
            ...
            .ID = "btnTest2"
        End With
        'pnlUpdate2.Controls.Add(btnTest)
        'Dim test As UpdatePanelControlTrigger
        'test.ControlID = "btnTest2"
        'pnlUpdate.Triggers.Add(test)
    End Sub
    ...
    Protected Sub btnXML_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnXML.Click
        ...
        ds = cPipelineData.GetWorkingPipeLineForExcelByBU(BU1.BU_ID, RadioButtonList1.SelectedValue)
