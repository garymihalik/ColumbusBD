...
Partial Class NewBenchReport
    ...
    Protected Sub grdItems_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdItems.RowDataBound
        ...
        gv.DataSource = cAssignments.GetPersonBenchDetails(DirectCast(e.Row.DataItem, DataRowView)("PK_PersonID").ToString(), strSort, txtEndDate.Text, False)
        gv.DataBind()
    End Sub
